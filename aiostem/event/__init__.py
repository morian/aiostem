...
#: Map of handled events names and their corresponding event parser class.
EVENT_MAP: Mapping[str, type[Event]] = {
...
def event_parser(message: Message) -> Event:
    """
    Parse the provided message to its corresponding event class.

    Args:
        message: the event message to parse

    Returns:
        An event object for the corresponding message.
