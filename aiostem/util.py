...
def is_valid_hs_v2_address(address: str) -> bool:
    """ Whether this address is a valid hidden service v2.
    """
    match = HS_V2_ADDRESS_PATTERN.match(address)
    return bool(match)
# End of function is_valid_hs_v2_address.


def is_valid_hs_v3_address(address: str) -> bool:
    """ Whether this address is a valid hidden service v3.
    ...
    return False
# End of function is_valid_hs_v3_address.
...
def hs_address_strip_tld(address: str) -> str:
    ...
    return address
# End of function hs_address_strip_tld.
...
def hs_address_version(address: str, allow_suffix: bool = False) -> int:
    ...
    return version
# End of function hs_address_version.


def is_valid_hs_address(address: str, allow_suffix: bool = False) -> bool:
    """ Whether this hidden service address is valid.
    """
    try:
        ...
        return False
    return True
# End of function is_valid_hs_address.
